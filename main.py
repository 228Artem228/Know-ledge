...
@application.route('/')
def index():
    return render_template('index.html', title='Know ledge')


@application.route('/reqister_student', methods=['GET', 'POST'])
...
@application.route('/register_teacher', methods=['GET', 'POST'])
...
@application.route('/student_profile')
def cabinet():
    if not current_user.is_authenticated:
        return redirect('/login')
...
@application.route('/teacher_profile')
def teacher_cabinet():
    if not current_user.is_authenticated:
        return redirect('/login')
...
@application.route('/all_courses', methods=['POST', 'GET'])
def all_courses():
    sorting = 'Все'
...
@application.route('/course/<int:course_id>/')
...
@application.route('/pass_task/<int:task_id>/', methods=['POST', 'GET'])
...
@application.route('/create_course', methods=['POST', 'GET'])
def create_Course():
    if not current_user.is_authenticated:
        return redirect('/login')
    if not current_user.is_teacher:
...
@application.route('/create_lesson', methods=['POST', 'GET'])
def create_lesson():
    if not current_user.is_authenticated:
        return redirect('/login')
    if not current_user.is_teacher:
...
@application.route('/teacher_students_add', methods=['POST', 'GET'])
...
@application.route('/teacher_students', methods=['POST', 'GET'])
...
@application.route('/teacher_students_add_course', methods=['POST', 'GET'])
...
@application.route('/teacher_students_remove_course', methods=['POST', 'GET'])
...
@application.route('/change_courses/')
def change_courses():
    if not current_user.is_authenticated:
        return redirect('/login')
    if not current_user.is_teacher:
...
@application.route('/change_lessons_courses/')
...
@application.route('/change_lessons_course/<int:course_id>/')
...
@application.route('/change_course/<int:course_id>/', methods=['POST', 'GET'])
...
@application.route('/change_lesson/<int:lesson_id>/', methods=['POST', 'GET'])
...
@application.route('/all_results_courses/')
...
@application.route('/all_results_lessons/<int:course_id>/')
...
@application.route('/all_results_lesson/<int:lesson_id>/')
...
@application.route('/all_results_courses_teacher/')
...
@application.route('/all_results_lessons_teacher/<int:course_id>/')
...
@application.route('/all_results_lesson_teacher/<int:lesson_id>/')
...
@application.route('/update_student_profile', methods=['POST', 'GET'])
...
@application.route('/update_teacher_profile', methods=['POST', 'GET'])
